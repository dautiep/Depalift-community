            ...
            <div class="top-menu">
                <ul class="nav navbar-nav float-right">
                    @auth
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle dropdown-header-name" style="padding-right: 10px" href="https://docs.google.com/document/d/1F4Xqq7mnp4f9d_tWdYzn3IG52Uwes-VGWq6xBv1fJsc/edit" target="_blank"><i class="fas fa-file-word"></i> <span class="d-none d-sm-inline">Tài liệu hướng dẫn</span> </a>
                        </li>
                            <li class="dropdown">

...
namespace Platform\CategoryTraining\Forms;
...
class CategoryTrainingForm extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        $this
            ->setupModel(new CategoryTraining)
            ->setValidatorClass(CategoryTrainingRequest::class)
            ->withCustomFields()
            ->add('name', 'text', [

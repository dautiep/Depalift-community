...
if (!function_exists('get_category_by_post')) {
     ...
     * @return array
     */
    function get_category_by_post($post_id)
    {
        return app(CategoryInterface::class)->getCategoryByPost($post_id);
    }
}

if (!function_exists('get_relate_post_by_category')) {
    /**
     * @param int $categoryId
     * @param int $limit
     * @return array
     */
    function get_relate_post_by_category($categoryId, $limit = 5)
    {
        return app(PostInterface::class)->getRelatedPostByCategory($categoryId, $limit);
    }
}

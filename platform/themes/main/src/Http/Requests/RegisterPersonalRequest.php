...
class RegisterPersonalRequest extends Request
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'num_phone'         => 'required|numeric|unique:app_member_personals,num_phone',
            'education'         => 'required',
            'works'             => 'required',
            'work_place'        => 'required',
            'position'          => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'file.required'           => 'Bạn phải tải lên đầy đủ các giấy tờ liên quan',
            'file.max'           => 'Bạn tải quá số lượng giấy tờ liên quan',
            'file.min'           => 'Bạn tải không đủ tệp tin yêu cầu là cam kết và đơn xin phép',

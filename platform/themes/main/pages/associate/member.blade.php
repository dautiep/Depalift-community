...
<section class="container">
    <section class="row">
        <div class="col-lg-8">
                                ...
                                <div class="mrb30 col-xs-6 col-sm-3">
                                    <div class="user-list text-xs-center transition">
                                        <a class="center-block user-img" href="{{$associate->create_url}}" target="_blank" title="{{$associate->name}}">
                                            <img class="img-fluid center-block" src="{{ RvMedia::getImageUrl($associate->image,'image_member', false, RvMedia::getImageUrl(theme_option('default_image'), 'image_member')) }}" alt="{{$associate->name}}">
                                        </a>
            ...
            <div class="col-md-12">
                <div class="user-wrap">
                <h1 class="title-line">{{$category->name}}</h1>
                    <div class="row">

                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-sub">
                            <a href="{{ route('rule')}}">
                                ...
                                {{__("Quy định trở thành hội viên")}}
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <section class="row">
        <div class="col-md-8">
            ...
            <h1 class="news-detail-title">{{@$page->name}}</h1>
                ...
                <br>
                <div class="news-detail-social" data-href="{{$share_rule}}">
                    <div class="face-share">
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{$share_rule}}" target="_blank" class="face-share-link">
                            <span>

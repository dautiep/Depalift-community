            ...
            <div class="form-inline">
                <div class="col-md-9 hidden-sm-down">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-sub">
                        <a href="{{ route('introduction.organizationalStructure')}}">
                                <i class="fas fa-angle-right"></i>
                                {{__("Cơ cấu tổ chức")}}
                            </a>
                        </li>
    ...
    <section class="row">
        <div class="col-md-8">
            ...
            <h1 class="news-detail-title">{{$page->name}}</h1>
                ...
                <br>
                <div class="news-detail-social" data-href="{{$share_structure}}">
                    <div class="face-share">
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{$share_structure}}" target="_blank" class="face-share-link">
                            <span>

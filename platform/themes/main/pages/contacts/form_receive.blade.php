                        ...
                        <table>
                            ...
                            <tr>
                                <td align="left" style="padding: 20px 50px;">
                                    <p><strong>Xin chào, Có một thông báo cho bạn từ website DEPALIFT COMMUNITY:</strong></p>
                                    <p><strong>Dear {{$input['name']}}!</strong></p>
                                    <p>Cảm ơn doanh nghiệp/đơn vị <strong>{{$input['company']}}</strong>  đã quan tâm đến hiệp hôi của chúng tôi</p>

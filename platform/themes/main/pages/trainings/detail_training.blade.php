                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-sub">
                            @if (count($name_category))  
                                <a href="{{route('training.category_training', $name_category[0]->slug)}}">
    ...
    <section class="row">
        <div class="col-md-8">
            <section class="news-detail">
                ...
                <br>
                <div class="news-detail-social" data-href="{{$share_training}}">
                    <div class="face-share">
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{$share_training}}" target="_blank" class="face-share-link">
                            <span>
